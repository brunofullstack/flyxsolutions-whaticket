...
import { FormControl, Grid, IconButton, Select, MenuItem, InputLabel } from "@material-ui/core";
...
const ScheduleSchema = Yup.object().shape({
	...
	recurrence: Yup.string().nullable(), // Validação do campo de recorrência
});
...
const ScheduleModal = ({ open, onClose, scheduleId, contactId, cleanContact, reload }) => {
	...
	const initialState = {
		...
		sentAt: "",
		recurrence: "" // Estado inicial da recorrência
	};
								...
								<div className={classes.multFieldLine}>
									<FormControl variant="outlined" fullWidth className={classes.formControl}>
										<InputLabel id="recurrence-label">Recorrência</InputLabel>
											...
											onChange={(e) => setFieldValue("recurrence", e.target.value)}
											label="Recorrência"
											>
